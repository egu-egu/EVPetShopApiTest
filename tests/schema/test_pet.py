...
class TestPet:
    ...
    def test_adding_full_pet_data(self):
        ...
        def test_update_info_pet(self, create_pet, update_pet):
            with allure.step("Получение ID созданного питомца"):
                pet_id = create_pet["id"]

            with allure.step("из фикстуры update_pet"):
                update_payload = update_pet.copy()
                update_payload["id"] = pet_id
        ...
        def test_delete_info_pet(self, create_pet, delete_pet):
            with allure.step("Получение ID созданного питомца"):
                pet_id = create_pet["id"]


            with allure.step("Отправить DELETE-запрос на /pet/{petId}"):
